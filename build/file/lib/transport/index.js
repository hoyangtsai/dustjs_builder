...
module.exports = function (options) {
	...
	function transport(file) {
		...
		oldAstSeaModule.dependencies = Array.from(new Set(oldAstSeaModule.dependencies || []));
		...
		file.contents = new Buffer(newContent.print_to_string({beautify:true, comments: true}))
